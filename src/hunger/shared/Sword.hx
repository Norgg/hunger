...
class Sword extends Entity {
	...
	public function new(player: Player) {
		...
		var shape = new Polygon(Polygon.box(3, 19));
		...
		if (player != null && player.local) {
			...
			joint = new PivotJoint(body, player.body, Vec2.weak(0, 9.5), Vec2.weak(0, -6));
		}
	...
	override public function draw() {
		...
		texture("img/sword.png", -3.5, -9.5);
		graphics.drawRect( -3.5, -9.5, 7, 19);
	}
